...
//		int thingOne = compDay + ((153 * compM + 2) / 5) + (365 * compY) + (compY / 4) - (compY / 100) + (compY / 400) - 32045;
//		int thingTwo = givenDay + ((153 * givenM + 2) / 5) + (365 * givenY) + (givenY / 4) - (givenY / 100) + (givenY / 400) - 32045;
//
...
//		int originalJulien = originalDay + ((153 * originalM + 2) / 5) + (365 * originalY) + (originalY / 4) - (originalY / 100) + (originalY / 400) - 32045;
//		
//		// adds/subtracts to get new Julien
